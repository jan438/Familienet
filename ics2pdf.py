...
mheaderStyle = ParagraphStyle('mhea', parent=styles['Normal'], fontName = calfont, fontSize = 12, textColor = orange, alignment=TA_CENTER, leading = 8, underlineOffset = -3, underlineWidth = 0.5, underlineColor = gray, backColor = "#ffffff")
