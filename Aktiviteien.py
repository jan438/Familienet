...
c.circle(50, 50, 50, stroke = 0, fill = 1)
c.rect(0, 0, 100, 100, stroke = 1, fill = 0)
drawing = scaleSVG("SVG/Reuzenrad.svg", 0.5)
renderPDF.draw(drawing, c, 18, 18)
c.setFont(activityfont, 18)
c.setFillColor(HexColor("#756bff"))
c.drawString(0, 0, "Hello World1")
c.showPage()
c.setFillColor(HexColor("#caffa9"))
c.circle(50, 50, 50, stroke = 0, fill = 1)
c.rect(0, 0, 100, 100, stroke = 1, fill = 0)
