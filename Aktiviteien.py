...
p = c.beginPath()
p.moveTo(activity_x + 100, 0)
p.lineTo(activity_x + 0, 50)
p.lineTo(activity_x + 100, 100)
p.curveTo(activity_x + 115, 100, activity_x + 115, 75, activity_x + 100, 75)
p.curveTo(activity_x + 120, 75, activity_x + 110, 25, activity_x + 97, 25)
p.curveTo(activity_x + 105, 25, activity_x + 110, 0, activity_x + 100, 0)
