...
p.moveTo(1*100, 0)
p.lineTo(0, 0.5*100)
p.lineTo(1*100, 1*100)
p.curveTo(1.15*100, 1*100, 1.15*100, 0.75*100, 1*100, 0.75*100)
p.curveTo(1.2*100, 0.75*100, 1.1*100, 0.25*100, 0.97*100, 0.25*100)
p.curveTo(1.05*100, 0.25*100, 1.1*100, 0, 1*100, 0)
